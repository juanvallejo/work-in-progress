...
public final class ItemDefinitions {
	...
	public HashMap<Integer, Integer> getWearingSkillRequiriments() {
		...
		if (itemRequiriments == null) {
			...
			else if (name.equals("Completionist cape")) {
			...
			else if (name.equals("Dungeoneering master cape")) {
	...
	private final void readValues(InputStream stream, int opcode) {
		...
		} else if((opcode >= 142 && opcode < 147) || opcode == 827) {
	...
	public static ItemDefinitions forId(int id2) {
