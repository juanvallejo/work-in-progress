...
public class Hiscores {
    ...
    public static void createConnection() {
        try {
            ...
            String IP="198.15.67.210";//connection ip
            String DB="qnmewxqn_root_highscores";//database name
            String User="qnmewxqn_high";//username
            String Pass="exoria123"; //password
    ...
    public static void restore(Player player) throws SQLException  {
        ...
        if (results.next()) {
    		for (int skill = 0; skill < player.getSkills().level.length; skill++) {
    			player.getSkills().level[skill] = (short) player.getSkills().getLevel(skill);
