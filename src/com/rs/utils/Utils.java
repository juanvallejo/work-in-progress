...
public final class Utils {
	...
	public static final int getRandomPlayer(int player) {
		return (int) (Math.random() * (player + 1));
	}
	...
	public static boolean invalidAccountName(String name) {
		return name.length() < 2 || name.length() > 12 || name.startsWith("_") || name.endsWith("_") || name.contains("__") || name.contains("ffsdragonkk") || name.contains("apache") || containsInvalidCharacter(name);
	}
