                ...
                if (instr != null) {
                    ...
                    while ((s = in.readLine()) != null) {
                        if (s.contains("<td align=\"center\"><a href=\"/wiki/Rare_drop_table\" title=\"Rare drop table\">") && b) {
                            ...
                            // itemDef = Class.forName(s.substring(s.indexOf("title=\"") + 7, s.indexOf("\"", s.indexOf("title=\"") + 7)));
                            System.out.println(s.substring(s.indexOf("title=\"") + 7, s.indexOf("\"", s.indexOf("title=\"") + 7)));
                            if (itemDef == null) {
                                try {
                                    // itemDef = Class.forName(s.substring(s.indexOf(s.substring(s.indexOf("title=\"") + 7, s.indexOf("\"", s.indexOf("title=\"") + 7))), s.indexOf(" (")).replace("'", "'"));
                                } catch (Exception e) {
                                }
                            }
                            b = false;
        ...
        for (Drop d : drops) {
            ...
            if(!d.isFromRareTable()) {
                ...
                model.addRow(new Object[] {
                    ...
                    // current rate of drop
                    Double.toString(d.getRate()), 

                    // calculate item amount
                    Integer.toString(d.getMinAmount()) + (d.getMinAmount() == d.getMaxAmount() || d.getMaxAmount() == 0 ? "" : "-" + d.getMaxAmount()), 

                    // display item name
                    ItemDefinitions.getItemDefinitions(d.getItemId()).getName()
