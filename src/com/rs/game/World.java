...
public final class World {
	...
	public static boolean isAtHome(WorldTile tile) {
		return (tile.getX() >= 3269 && tile.getX() <= 3289 && tile.getY() >= 3485 && tile.getY() <= 3512);
	}
	...
	public static final void spawnObject(WorldObject object, boolean clip) {
		...
		// manually delete fences
		if(object.getId() != 17783 && object.getY() != 2845) {			
