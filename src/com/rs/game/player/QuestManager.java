...
public final class QuestManager implements Serializable {
	...
	public void checkCompleted() {
		...
		else if(!completedQuests.contains(Quests.LOST_CITY)
			&& player.getSkills().hasRequiriments(Skills.WOODCUTTING, 36, Skills.CRAFTING, 31))
			completeQuest(Quests.LOST_CITY);
	}
