...
public class Fletching extends Action {
	...
	public static enum Fletch {
		...
		REGULAR_BOW(1511, 946, new int[] { 52, 50, 48, 9440 }, new int[] { 1, 5, 10, 9 }, new double[] { 0.33, 5, 10, 6 },
				new Animation(6702)),
	...
	public static boolean maxMakeQuantityTen(Fletch fletch) {
		return fletch.getSelected() == 52 || fletch.getSelected() == 53 || fletch.getSelected() == 314 || ItemDefinitions.getItemDefinitions(fletch.getSelected()).getName().toLowerCase().contains("dart");
	}
	
	/**
	 * Fixed 1 Log making 20 odd Short bows
	 * Removed the "fletch.getProduct()[0] == 52 || " from above.
	 * Fixed small bugs
	 * - Santa Hat
	 */
