...
public final class FarmWoodcutting extends Action {
	...
	public static enum TreeDefinitions {
		...
		YEW_TREE(60, 175, 1515, 120, 17, 1341, 94, 10), // TODO

		IVY(68, 332.5, -1, 120, 17, 46319, 58, 10),

		MAGIC_TREE(75, 250, 1513, 150, 21, 37824, 121, 10),
	...
	public FarmWoodcutting(WorldObject tree, TreeDefinitions definitions) {
		this.tree = tree;
