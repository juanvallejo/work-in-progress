...
public class BoxAction extends Action {
	...
	public enum HunterNPC {
		...
		BLACK_SALAMANDER(5116, new Item[] {new Item(10162, 1)}, 67, 100, HunterEquipment.SALAMANDER, 28557, 19192, new Animation(8343), new Animation(8345));
	...
	public enum HunterEquipment {
		BOX(10008, 19187, new Animation(5208), 27), SALAMANDER(303, 19670, new Animation(923), 67), BRID_SNARE(10006, 19175, new Animation(5207), 1), LARUPIA_PITFALL(-1, 19232, new Animation(5207), 31);
