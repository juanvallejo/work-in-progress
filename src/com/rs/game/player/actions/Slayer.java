...
public class Slayer {
	...
	public static boolean checkRequirement(Player player, SlayerMonsters monster) {
		if (monster != null) {
		if (player.getSkills().getLevel(Skills.SLAYER) < monster
				.getRequirement()) {
			player.getPackets().sendGameMessage(
					"Your Slayer level must be at least " + monster.getRequirement()
