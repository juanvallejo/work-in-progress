...
public final class PestControlLobby extends Controler {
	...
	public void sendInterfaces() {
		...
		player.getPackets().sendIComponentText(407, 14, "Players Aboard: " + player.lander);
		player.getPackets().sendIComponentText(407, 16, "Pest Points: " + player.pestControlPoint);
