	...
	public static final void init() {
		try {
			...
			Class<Controler> value21 = (Class<Controler>) Class
					.forName(TutorialIslandd.class.getCanonicalName());
			handledControlers.put("TutorialIslandd", value21);
			Class<Controler> value22 = (Class<Controler>) Class
					.forName(RubberChicken.class.getCanonicalName());
			handledControlers.put("RubberChicken", value22);
			...
			handledControlers.put("WGuildControler", value24);
			...
			handledControlers.put("GloveMinigameControler", (Class<Controler>) Class.forName(FightCaves.class.getCanonicalName()));
			...
			handledControlers.put("ZombieMinigameControler", (Class<Controler>) Class.forName(ZombieMinigame.class.getCanonicalName()));
