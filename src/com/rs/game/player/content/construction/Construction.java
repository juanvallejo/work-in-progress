...
public class Construction {
	...
	public static void tableConfigs(Player p, String name, int exp, int id,
		...
		p.getPackets().sendGameMessage("you have packed a new " + name + " !");
	}

	public static void tableCloseMsg(Player player, String string) {
		player.getInterfaceManager().closeScreenInterface();
		player.getPackets().sendGameMessage("Minimum " + string + " required.");
	}
...

	{
		...
		p.getPackets()
				.sendGameMessage(
						" You must have a saw and a hammer in your inventory to construct this item");
	}
