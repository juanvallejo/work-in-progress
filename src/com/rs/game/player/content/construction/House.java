...
public class House {
	...
	public House() {		
		...
		rooms.add(new RoomReference(Room.Portal, 4, 5, 0, 0));
		rooms.add(new RoomReference(Room.Throne, 3, 4, 0, 3));
		rooms.add(new RoomReference(Room.Chapel, 4, 3, 0, 2));*/
		//rooms.add(new RoomReference(Room.Study, 4, 3, 0, 2));
		//rooms.add(new RoomReference(Room.QuestHall, 4, 3, 0, 2));
		//rooms.add(new RoomReference(Room.BOXING, 3, 4, 0, 3));
		//rooms.add(new RoomReference(Room.BEDROOM, 3, 4, 0, 2));
		//rooms.add(new RoomReference(Room.DININGROOM, 4, 3, 0, 2));
		//rooms.add(new RoomReference(Room.WorkShop, 3, 4, 0, 1));
		place = 0; //desert
		look = 5; //idk style
	}
