			...
			public void extra(final Player player) {
				...
				WorldTasksManager.schedule(new WorldTask() {
					...
					public void run() {
						...
						if (!stop) {
							player.getPackets().sendGameMessage("<col=480000>Your super antifire potion is about to run out...</col>");
							stop = true;
						} else {
							stop();
							player.getPackets().sendGameMessage("<col=480000>Your super antifire potion has ran out...</col>");
						}		
					}
				}, 500, 100);
			}
