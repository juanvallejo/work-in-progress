...
public class Magic {
	...
	public static final int MAGIC_TELEPORT = 0, ITEM_TELEPORT = 1, OBJECT_TELEPORT = 2, WILDY_TELEPORT = 4;
	...
	public static final void sendWildyTeleport(Player player, int level, double xp, WorldTile tile, int... runes) {	
		sendTeleportSpell(player, 9602, -1, 661, -1, level, xp, tile, 3, true, WILDY_TELEPORT, runes);
	}
