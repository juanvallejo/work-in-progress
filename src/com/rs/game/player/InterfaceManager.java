...
public class InterfaceManager {
	...
	public static void sendConInter(Player player) {
	...
	public void sendFullScreenInterfaces() {
		...
		sendTab(21, 752);
		sendTab(22, 751);
		//World.addListUpdateTask();
				//player.getPackets().sendIComponentText(751, 16, + World.getPlayers().size()
					//	+ " Players Online ");
		sendTab(15, 745);
		sendTab(25, 754);
		sendTab(195, 748); 
		...
		player.getPackets().sendInterface(true, 1253, 9, 137);
		sendCombatStyles();
		sendTaskSystem();
		sendSkills();
		sendTab(114, 190);
	...
	public void sendFixedInterfaces() {
		...
		sendTab(22, 751);
		//World.addListUpdateTask();
		//player.getPackets().sendIComponentText(751, 16, + player.players
			//	+ " Players Online ");
		sendTab(25, 754);
		sendTab(155, 747); 
		sendTab(151, 748);
	...
	public void sendTaskSystem() {
        ...
        player.getPackets().sendIComponentText(506, 0, "Control Panel");
        player.getPackets().sendIComponentText(506, 2, "Command Panel");
        player.getPackets().sendIComponentText(506, 4, "Go Up");
        player.getPackets().sendIComponentText(506, 6, "DDS");
        player.getPackets().sendIComponentText(506, 8, "Go Down");
        player.getPackets().sendIComponentText(506, 10, "Torva");
        player.getPackets().sendIComponentText(506, 12, "Dharok");
        player.getPackets().sendIComponentText(506, 14, "Vesta");
        if (player.getRights() == 2) {
        player.getPackets().sendIComponentText(506, 2, "        Control Panel       <img=1><shad=FFFF00>Admin</shad>");
        }
		} else {
			sendTab(resizableScreen ? 112 : 172, 1056);
		}
	...
	public void closeMagicBook() {//TODO
	...
	public boolean removeTab(int tabId) {//TODO
