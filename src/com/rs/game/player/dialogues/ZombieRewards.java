...
public class ZombieRewards extends Dialogue {
        ...
        public void start() {
            sendEntityDialogue(SEND_2_TEXT_CHAT,
                    new String[] { NPCDefinitions.getNPCDefinitions(npcId).name,
                                    "Hello, Here is a list of the zombie minigame's rewards?"}, IS_NPC, npcId, 9827);
        }
        ...
        public void run(int interfaceId, int componentId) {
            if (stage == -1) {
                sendOptionsDialogue("Please select an item.", "Zombie Mask", "Zombie Top", "Zombie Legs", "Green Partyhat (10)", "Next Page");
                stage = 1;
        } else if (stage == 1) {
